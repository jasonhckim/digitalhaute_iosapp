...
import { ProductStorage, VendorStorage, BudgetStorage } from "@/lib/storage";
...
export default function EditProductScreen() {
  ...
  const loadProduct = async () => {
    try {
      const [product, vendorsList] = await Promise.all([
        ProductStorage.getById(route.params.productId),
      ...
      if (product) {
        ...
        setStyleNumber(product.styleNumber);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await ProductStorage.update(route.params.productId, {
        name: name.trim(),
